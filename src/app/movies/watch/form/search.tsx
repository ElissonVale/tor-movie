...
type Props = {
    placeholder?: string,
    onHandler: (searchTerm: string) => void
}

export const SearchComponent = ({ placeholder, onHandler }: Props) => {

    const [searchTerm, setSearchTerm] = useState<string>("")

    const onHadler = (form: any) => {

        form.preventDefault()

        onHandler(searchTerm)
    }

    return (
        <form onSubmit={onHadler} className="max-w-lg mx-auto my-10">
